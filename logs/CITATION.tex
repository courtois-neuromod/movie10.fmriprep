...
reconstruction nomenclature): \emph{fsaverage}. The BOLD time-series
...
custom methodology of \emph{fMRIPrep}. \emph{Grayordinates} files
...
surface space. Several confounding time-series were calculated based on
